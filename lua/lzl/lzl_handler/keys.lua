...
---@class LzlKeysSpec: LzlKeysBase
---@field [1] string lhs
---@field [2]? string|fun():string?|false rhs
---@field mode? string|string[]

---@class LzlKeys: LzlKeysBase
...
---@class LzlKeysHandler:LzlHandler
local M = {}

local skip = { mode = true, id = true, ft = true, rhs = true, lhs = true }

---@param value string|LzlKeysSpec
---@param mode? string
---@return LzlKeys
function M.parse(value, mode)
    value = type(value) == "string" and { value } or value --[[@as LzlKeysSpec]]
    local ret = vim.deepcopy(value) --[[@as LzlKeys]]
    ret.lhs = ret[1] or ""
    ret.rhs = ret[2]
